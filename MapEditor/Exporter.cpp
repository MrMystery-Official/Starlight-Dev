    ...
    if (Editor::Identifier.length() != 0) {
        ...
        for (Actor& ExportedActor : ActorMgr::GetActors()) {
            if (ExportedActor.Dynamic.DynamicString.count("BancPath")) {
                if (ExportedActor.MergedActorByml.HasChild("Actors"))
                    ExportedActor.MergedActorByml.GetNode("Actors")->GetChildren().clear();
                else {
                ...
                for (Actor MergedActor : ExportedActor.MergedActorContent) {
                    ...
                    float NewX = ExportedActor.Translate.GetX() + ((MergedActor.Translate.GetX() - ExportedActor.Translate.GetX()) * (std::cosf(RadianRotate.GetZ()) * std::cosf(RadianRotate.GetY()))) + ((MergedActor.Translate.GetY() - ExportedActor.Translate.GetY()) * (std::cosf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetY()) * std::sinf(RadianRotate.GetX()) - std::sinf(RadianRotate.GetZ()) * std::cosf(RadianRotate.GetX()))) + ((MergedActor.Translate.GetZ() - ExportedActor.Translate.GetZ()) * (std::cosf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetY()) * std::cosf(RadianRotate.GetX()) + std::sinf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetX())));

                    float NewY = ExportedActor.Translate.GetY() + ((MergedActor.Translate.GetX() - ExportedActor.Translate.GetX()) * (std::sinf(RadianRotate.GetZ()) * std::cosf(RadianRotate.GetY()))) + ((MergedActor.Translate.GetY() - ExportedActor.Translate.GetY()) * (std::sinf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetY()) * std::sinf(RadianRotate.GetX()) + std::cosf(RadianRotate.GetZ()) * std::cosf(RadianRotate.GetX()))) + ((MergedActor.Translate.GetZ() - ExportedActor.Translate.GetZ()) * (std::sinf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetY()) * std::cosf(RadianRotate.GetX()) - std::cosf(RadianRotate.GetZ()) * std::sinf(RadianRotate.GetX())));

                    float NewZ = ExportedActor.Translate.GetZ() + ((MergedActor.Translate.GetX() - ExportedActor.Translate.GetX()) * (-std::sinf(RadianRotate.GetY()))) + ((MergedActor.Translate.GetY() - ExportedActor.Translate.GetY()) * (std::cosf(RadianRotate.GetY()) * std::sinf(RadianRotate.GetX()))) + ((MergedActor.Translate.GetZ() - ExportedActor.Translate.GetZ()) * (std::cosf(RadianRotate.GetY()) * std::cosf(RadianRotate.GetX())));
