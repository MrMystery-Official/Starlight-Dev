...
{
	class UIAINBEditorNodeSequential : public application::rendering::ainb::UIAINBEditorNodeBase
	{
	public:
		UIAINBEditorNodeSequential(int UniqueId, application::file::game::ainb::AINBFile::Node& Node);
