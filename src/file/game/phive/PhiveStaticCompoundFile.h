...
{
	struct PhiveStaticCompoundFile
	{
		...
		struct PhiveStaticCompoundHkTagFile
		{
			...
			application::file::game::phive::classes::HavokTagFile<application::file::game::phive::classes::HavokClasses::hknpCompoundShape> mTagFile;
		};
		...
		struct PhiveStaticCompoundBphsh
		{
			...
			std::vector<uint8_t> mReserve1Array;
		...
		PhiveStaticCompoundFile(std::vector<unsigned char> Bytes);
		PhiveStaticCompoundFile() = default;
	};
}