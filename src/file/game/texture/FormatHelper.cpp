...
{
	std::unordered_map<TextureFormat::Format, GLenum> FormatHelper::gInternalFormatList =
	{
	...
	std::unordered_map<GLenum, int32_t> FormatHelper::gBlockSizeByFormat =
	{
	...
	std::unordered_map<std::string, GLenum> FormatHelper::gAlphaTestFunctions =
	{
		{"gequal", GL_GEQUAL},
		{"always", GL_ALWAYS},
		{"never", GL_NEVER},
